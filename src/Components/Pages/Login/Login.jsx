            ...
            <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-[1170px]">
                ...
                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div>
                            <small><p className='font-poppins mt-3'>Don't  have an account? <span className='text-purple-600 font-semibold hover:underline'><Link to='/register'>Sing Up </Link></span></p></small>
                        </div>
                    </form>
                    {/* <div className="flex items-center justify-between mt-4">
