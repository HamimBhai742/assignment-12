            ...
            <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-[1170px]">
                ...
                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <a href="#" className="text-xs text-gray-500 font-inter uppercase dark:text-gray-400 hover:underline">or sign up</a>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="mt-6">
                            <button className="w-full bg-purple-600 px-6 py-3 font-inter font-bold tracking-wide text-white capitalize transition-colors duration-300 transform rounded-lg hover:bg-purple-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
                                Sign Up
                            </button>
                        </div>
                        <div>
                            <small><p className='font-poppins mt-3'>Already have an account? <span className='text-purple-600 font-semibold hover:underline'><Link to='/login'>Sign In</Link></span></p></small>
                        </div>
                    </form>
                    {/* <div className="flex items-center justify-between mt-4">
